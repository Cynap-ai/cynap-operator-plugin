...
// see the local proxy source/operator-proxy.mjs pkceLoopbackLogin), `--device` is the
 ...
 * (the local proxy source/operator-proxy.mjs DEFAULT_ORG_SLUG / DEFAULT_TARGET_ORG_ID).
 ...
 * class the workspace instructions calls out: two disagreeing string literals with
 ...
 * the local proxy source/operator-proxy.mjs parseArgs) — this is the client-side
